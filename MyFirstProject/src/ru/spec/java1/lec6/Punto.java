...
public class Punto {
	...
	static {
		String enLayout = "`1234567890-=qwertyuiop[]asdfghjkl;'\\zxcvbnm,./" + 	"~!@#$%^&*()_+QWERTYUIOP{}ASDFGHJKL:\"|ZXCVBNM<>?";
		String ruLayout = "ё1234567890-=йцукенгшщзхъфывапролджэ\\ячсмитьбю."+ 	"Ё!\"№;%:?*()_+ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭ/ЯЧСМИТЬБЮ,";
	...
	public static void main(String[] args) {
		...
		System.out.println(ruToEn("Ыныеуь щге"));
